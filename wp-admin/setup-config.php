...
if ( version_compare( $required_php_version, phpversion(), '>' ) )
	wp_die( sprintf( /*WP_I18N_OLD_PHP*/'Su servidor está ejecutando la versión %1$s de PHP, pero WordPress requiere al menos la %2$s.'/*/WP_I18N_OLD_PHP*/, phpversion(), $required_php_version ) );

if ( !extension_loaded('mysql') && !file_exists(ABSPATH . 'wp-content/db.php') )
	wp_die( /*WP_I18N_OLD_MYSQL*/'Su instalaci&oacute;n de PHP parece faltar la extensi&oacute;n de MySQL que se requiere para WordPress.'/*/WP_I18N_OLD_MYSQL*/ );
...
<?php
	...
	if ( preg_match( '|[^a-z0-9_]|i', $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>ERROR</strong>: "Table Prefix" sólo puede contener números, letras y guiones bajos.'/*/WP_I18N_BAD_PREFIX*/ );
