...
function wp_unregister_GLOBALS() {
	...
	if ( isset( $_REQUEST['GLOBALS'] ) )
		die( /*WP_I18N_GLOBALS_OVERWRITE*/'Se ha detectado un intento GLOBAL de sobreescritura'/*/WP_I18N_GLOBALS_OVERWRITE*/ );
...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) )
		die( sprintf( /*WP_I18N_OLD_PHP*/'Su servidor está ejecutando la versión %1$s de PHP, pero WordPress %2$s requiere al menos la %3$s.'/*/WP_I18N_OLD_PHP*/, $php_version, $wp_version, $required_php_version ) );

	if ( !extension_loaded( 'mysql' ) && !file_exists( WP_CONTENT_DIR . '/db.php' ) )
		die( /*WP_I18N_OLD_MYSQL*/'Su instalaci&oacute;n de PHP parece faltar la extensi&oacute;n de MySQL que se requiere para WordPress.'/*/WP_I18N_OLD_MYSQL*/ );
}
...
?>
	...
	<body>
		<h1><?php echo /*WP_I18N_MAINT_MSG*/'Lo sentimos, en este momento nos encontramos en mantenimiento. Por favor, vuelva en un minuto.'/*/WP_I18N_MAINT_MSG*/; ?></h1>
	</body>
	</html>
<?php
	die();
...
function wp_set_wpdb_vars() {
	...
	if ( is_wp_error( $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>ERROR</strong>: <code>$table_prefix</code> en <code>wp-config.php</code> s&oacute;lo puede contener n&uacute;meros, letras y guiones bajos.'/*/WP_I18N_BAD_PREFIX*/ );
}
